#ifndef __HC32F10x_GPIO_H
#define __HC32F10x_GPIO_H
...
#define GPIO_CRL(GPIOn)				(*(volatile uint32_t *)(uint32_t)(GPIOn + 0x00))
#define GPIO_CRH(GPIOn)				(*(volatile uint32_t *)(uint32_t)(GPIOn + 0x04))
#define GPIO_IDR(GPIOn)				(*(volatile uint32_t *)(uint32_t)(GPIOn + 0x08))
#define GPIO_ODR(GPIOn)				(*(volatile uint32_t *)(uint32_t)(GPIOn + 0x0C))
#define GPIO_BSRR(GPIOn)			(*(volatile uint32_t *)(uint32_t)(GPIOn + 0x10))
#define GPIO_BRR(GPIOn)				(*(volatile uint32_t *)(uint32_t)(GPIOn + 0x14))
#define GPIO_LCKR(GPIOn)			(*(volatile uint32_t *)(uint32_t)(GPIOn + 0x18))

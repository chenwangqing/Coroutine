...
static void TI1_Config(uint32_t TIMx, uint16_t TIM_ICPolarity, uint16_t TIM_ICSelection,
                       uint16_t TIM_ICFilter);
static void TI2_Config(uint32_t TIMx, uint16_t TIM_ICPolarity, uint16_t TIM_ICSelection,
                       uint16_t TIM_ICFilter);
static void TI3_Config(uint32_t TIMx, uint16_t TIM_ICPolarity, uint16_t TIM_ICSelection,
                       uint16_t TIM_ICFilter);
static void TI4_Config(uint32_t TIMx, uint16_t TIM_ICPolarity, uint16_t TIM_ICSelection,
                       uint16_t TIM_ICFilter);
...
void TIM_TimeBaseInit(uint32_t TIMx, TIM_TimeBaseInitTypeDef* TIM_TimeBaseInitStruct)
{
  ...
  TIM_ARR(TIMx)	 = TIM_TimeBaseInitStruct->TIM_Period ;
 
  /* Set the Prescaler value */
  TIM_PSC(TIMx)	 = TIM_TimeBaseInitStruct->TIM_Prescaler;
    
  if ((TIMx == TIM1) || (TIMx == TIM8)|| (TIMx == TIM15)|| (TIMx == TIM16) || (TIMx == TIM17))  
  {
    /* Set the Repetition Counter value */
    TIM_RCR(TIMx)	 = TIM_TimeBaseInitStruct->TIM_RepetitionCounter;
  }

  /* Generate an update event to reload the Prescaler and the Repetition counter
     values immediately */
  TIM_EGR(TIMx)	 = TIM_PSCReloadMode_Immediate;           
}
...
void TIM_OC1Init(uint32_t TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
 ...
 /* Disable the Channel 1: Reset the CC1E Bit */
  TIM_CCER(TIMx)	 &= (uint16_t)(~(uint16_t)TIM_CCER_CC1E);
  /* Get the TIMx CCER register value */
  tmpccer = TIM_CCER(TIMx)	;
  /* Get the TIMx CR2 register value */
  tmpcr2 =  TIM_CR2(TIMx)	;
  
  /* Get the TIMx CCMR1 register value */
  tmpccmrx = TIM_CCMR1(TIMx)	;
  ...
  /* Write to TIMx CCMR1 */
  TIM_CCMR1(TIMx)	 = tmpccmrx;

  /* Set the Capture Compare Register value */
  TIM_CCR1(TIMx)	 = TIM_OCInitStruct->TIM_Pulse; 
 
  /* Write to TIMx CCER */
  TIM_CCER(TIMx)	 = tmpccer;
}
...
void TIM_OC2Init(uint32_t TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
  ...
  TIM_CCER(TIMx)	 &= (uint16_t)(~((uint16_t)TIM_CCER_CC2E));
  ...
  /* Set the Capture Compare Register value */
  TIM_CCR2(TIMx)	 = TIM_OCInitStruct->TIM_Pulse;
...
void TIM_OC3Init(uint32_t TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
  ...
  /* Disable the Channel 2: Reset the CC2E Bit */
  TIM_CCER(TIMx)	 &= (uint16_t)(~((uint16_t)TIM_CCER_CC3E));
  ...
  /* Write to TIMx CCMR2 */
  TIM_CCMR2(TIMx)	 = tmpccmrx;

  /* Set the Capture Compare Register value */
  TIM_CCR3(TIMx)	 = TIM_OCInitStruct->TIM_Pulse;
...
void TIM_OC4Init(uint32_t TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
 ...
 /* Disable the Channel 2: Reset the CC4E Bit */
  TIM_CCER(TIMx)	 &= (uint16_t)(~((uint16_t)TIM_CCER_CC4E));
  ...
  /* Set the Capture Compare Register value */
  TIM_CCR4(TIMx) = TIM_OCInitStruct->TIM_Pulse;
...
void TIM_BDTRConfig(uint32_t TIMx, TIM_BDTRInitTypeDef *TIM_BDTRInitStruct)
{
 /* Set the Lock level, the Break enable Bit and the Ploarity, the OSSR State,
  ...
  TIM_BDTR(TIMx) = (uint32_t)TIM_BDTRInitStruct->TIM_OSSRState | TIM_BDTRInitStruct->TIM_OSSIState |
...
void TIM_Cmd(uint32_t TIMx, FunctionalState NewState)
{
  if (NewState != DISABLE)
  {
    ...
    TIM_CR1(TIMx)	 |= TIM_CR1_CEN;
  }
  else
  {
    /* Disable the TIM Counter */
    TIM_CR1(TIMx)	 &= (uint16_t)(~((uint16_t)TIM_CR1_CEN));
  }
}
 ...
 if (NewState != DISABLE)
  {
    ...
    TIM_BDTR(TIMx) |= TIM_BDTR_MOE;
  }
  else
  {
    /* Disable the TIM Main Output */
    TIM_BDTR(TIMx) &= (uint16_t)(~((uint16_t)TIM_BDTR_MOE));
  }  
}
...
{   
  if (NewState != DISABLE)
  {
    ...
    TIM_DIER(TIMx)	 |= TIM_IT;
  }
  else
  {
    /* Disable the Interrupt sources */
    TIM_DIER(TIMx)	 &= (uint16_t)~TIM_IT;
  }
}
...
void TIM_DMAConfig(uint32_t TIMx, uint16_t TIM_DMABase, uint16_t TIM_DMABurstLength)
{
 /* Set the DMA Base and the DMA Burst Length */
  TIM_DCR(TIMx)	 = TIM_DMABase | TIM_DMABurstLength;
}
...
{   
  if (NewState != DISABLE)
  {
    ...
    TIM_DIER(TIMx)	 |= TIM_DMASource; 
  }
  else
  {
    /* Disable the DMA sources */
    TIM_DIER(TIMx)	 &= (uint16_t)~TIM_DMASource;
  }
}
...
void TIM_InternalClockConfig(uint32_t TIMx)
{
  ...
  TIM_SMCR(TIMx)	 &=  (uint16_t)(~((uint16_t)TIM_SMCR_SMS));
}
...
void TIM_ITRxExternalClockConfig(uint32_t TIMx, uint16_t TIM_InputTriggerSource)
{
  ...
  TIM_SMCR(TIMx)	 |= TIM_SlaveMode_External1;
}
...
void TIM_PrescalerConfig(uint32_t TIMx, uint16_t Prescaler, uint16_t TIM_PSCReloadMode)
{
  ...
  /* Set the Prescaler value */
  TIM_PSC(TIMx)	 = Prescaler;
  /* Set or reset the UG Bit */
  TIM_EGR(TIMx)	 = TIM_PSCReloadMode;
}
...
void TIM_ForcedOC3Config(uint32_t TIMx, uint16_t TIM_ForcedAction)
{
  ...
  tmpccmr2 = TIM_CCMR2(TIMx)	;
  /* Reset the OC1M Bits */
  tmpccmr2 &= (uint16_t)~((uint16_t)TIM_CCMR2_OC3M);
  /* Configure The Forced output Mode */
  tmpccmr2 |= TIM_ForcedAction;
  /* Write to TIMx CCMR2 register */
  TIM_CCMR2(TIMx)	 = tmpccmr2;
}
...
void TIM_ARRPreloadConfig(uint32_t TIMx, FunctionalState NewState)
{
	...
	if (NewState != DISABLE)
  {
    ...
    TIM_CR1(TIMx)	 |= TIM_CR1_ARPE;
  }
  else
  {
    /* Reset the ARR Preload Bit */
    TIM_CR1(TIMx)	 &= (uint16_t)~((uint16_t)TIM_CR1_ARPE);
  }
}
...
void TIM_SelectCOM(uint32_t TIMx, FunctionalState NewState)
{
  ...
  {
    /* Set the COM Bit */
    TIM_CR2(TIMx)	 |= TIM_CR2_CCUS;
  }
  else
  {
    /* Reset the COM Bit */
    TIM_CR2(TIMx)	 &= (uint16_t)~((uint16_t)TIM_CR2_CCUS);
  }
}
...
void TIM_SelectCCDMA(uint32_t TIMx, FunctionalState NewState)
{
  ...
  {
    /* Set the CCDS Bit */
    TIM_CR2(TIMx)	 |= TIM_CR2_CCDS;
  }
  else
  {
    /* Reset the CCDS Bit */
    TIM_CR2(TIMx)	 &= (uint16_t)~((uint16_t)TIM_CR2_CCDS);
  }
}
...
{ 
  ...
  {
    /* Set the CCPC Bit */
    TIM_CR2(TIMx)	 |= TIM_CR2_CCPC;
  }
  else
  {
    /* Reset the CCPC Bit */
    TIM_CR2(TIMx)	 &= (uint16_t)~((uint16_t)TIM_CR2_CCPC);
  }
}
...
void TIM_CCxCmd(uint32_t TIMx, uint16_t TIM_Channel, uint16_t TIM_CCx)
{
  ...
  /* Reset the CCxE Bit */
  TIM_CCER(TIMx)	 &= (uint16_t)~ tmp;

  /* Set or reset the CCxE Bit */ 
  TIM_CCER(TIMx)	 |=  (uint16_t)(TIM_CCx << TIM_Channel);
}
...
void TIM_CCxNCmd(uint32_t TIMx, uint16_t TIM_Channel, uint16_t TIM_CCxN)
{
  ...
  TIM_CCER(TIMx)	 |=  (uint16_t)(TIM_CCxN << TIM_Channel);
}
...
void TIM_UpdateDisableConfig(uint32_t TIMx, FunctionalState NewState)
{
  if (NewState != DISABLE)
  {
    ...
    TIM_CR1(TIMx)	 |= TIM_CR1_UDIS;
  }
  else
  {
    /* Reset the Update Disable Bit */
    TIM_CR1(TIMx)	 &= (uint16_t)~((uint16_t)TIM_CR1_UDIS);
  }
}
...
void TIM_UpdateRequestConfig(uint32_t TIMx, uint16_t TIM_UpdateSource)
{
  ...
  {
    /* Set the URS Bit */
    TIM_CR1(TIMx)	 |= TIM_CR1_URS;
  }
  else
  {
    /* Reset the URS Bit */
    TIM_CR1(TIMx)	 &= (uint16_t)~((uint16_t)TIM_CR1_URS);
  }
}
...
void TIM_SelectHallSensor(uint32_t TIMx, FunctionalState NewState)
{
  ...
  {
    /* Set the TI1S Bit */
    TIM_CR2(TIMx)	 |= TIM_CR2_TI1S;
  }
  else
  {
    /* Reset the TI1S Bit */
    TIM_CR2(TIMx)	 &= (uint16_t)~((uint16_t)TIM_CR2_TI1S);
  }
}
...
{
 /* Reset the OPM Bit */
  TIM_CR1(TIMx)	 &= (uint16_t)~((uint16_t)TIM_CR1_OPM);
  /* Configure the OPM Mode */
  TIM_CR1(TIMx)	 |= TIM_OPMode;
}
...
{
 /* Reset the MMS Bits */
  TIM_CR2(TIMx)	 &= (uint16_t)~((uint16_t)TIM_CR2_MMS);
  /* Select the TRGO source */
  TIM_CR2(TIMx)	 |=  TIM_TRGOSource;
}
...
{
  /* Reset the MSM Bit */
  TIM_SMCR(TIMx)	 &= (uint16_t)~((uint16_t)TIM_SMCR_MSM);
  
  /* Set or Reset the MSM Bit */
  TIM_SMCR(TIMx)	 |= TIM_MasterSlaveMode;
}
...
void TIM_SetIC1Prescaler(uint32_t TIMx, uint16_t TIM_ICPSC)
{
  ...
  TIM_CCMR1(TIMx)	 &= (uint16_t)~((uint16_t)TIM_CCMR1_IC1PSC);
  /* Set the IC1PSC value */
  TIM_CCMR1(TIMx)	 |= TIM_ICPSC;
}
...
void TIM_SetIC2Prescaler(uint32_t TIMx, uint16_t TIM_ICPSC)
{
 /* Reset the IC2PSC Bits */
  TIM_CCMR1(TIMx)	 &= (uint16_t)~((uint16_t)TIM_CCMR1_IC2PSC);
  /* Set the IC2PSC value */
  TIM_CCMR1(TIMx)	 |= (uint16_t)(TIM_ICPSC << 8);
}
...
void TIM_SetIC3Prescaler(uint32_t TIMx, uint16_t TIM_ICPSC)
{
  ...
  TIM_CCMR2(TIMx)	 &= (uint16_t)~((uint16_t)TIM_CCMR2_IC3PSC);
  /* Set the IC3PSC value */
  TIM_CCMR2(TIMx)	 |= TIM_ICPSC;
}
...
{  
 /* Reset the IC4PSC Bits */
  TIM_CCMR2(TIMx)	 &= (uint16_t)~((uint16_t)TIM_CCMR2_IC4PSC);
  /* Set the IC4PSC value */
  TIM_CCMR2(TIMx)	 |= (uint16_t)(TIM_ICPSC << 8);
}
...
{
  /* Reset the CKD Bits */
  TIM_CR1(TIMx)	 &= (uint16_t)~((uint16_t)TIM_CR1_CKD);
  /* Set the CKD value */
  TIM_CR1(TIMx)	 |= TIM_CKD;
}
...
{ 
  ...
  if ((TIM_SR(TIMx)	 & TIM_FLAG) != (uint16_t)RESET)
  {
    bitstatus = SET;
  }
  else
...
ITStatus TIM_GetITStatus(uint32_t TIMx, uint16_t TIM_IT)
{
  ...
  itstatus = TIM_SR(TIMx)	 & TIM_IT;
  
  itenable = TIM_DIER(TIMx)	 & TIM_IT;

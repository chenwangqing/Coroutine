...
/*---------------------------- I2Cx OAR1 Configuration -----------------------*/
  ...
  I2C_OAR1(I2Cx) = (I2C_InitStruct->I2C_AcknowledgedAddress | I2C_InitStruct->I2C_OwnAddress1);
}
...
void I2C_DMACmd(uint32_t I2Cx, FunctionalState NewState)
{
  if (NewState != DISABLE)
  {
    ...
    I2C_CR2(I2Cx) |= CR2_DMAEN_Set;
  }
  else
  {
    /* Disable the selected I2C DMA requests */
    I2C_CR2(I2Cx) &= CR2_DMAEN_Reset;
  }
}
...
void I2C_DMALastTransferCmd(uint32_t I2Cx, FunctionalState NewState)
{
  if (NewState != DISABLE)
  {
    ...
    I2C_CR2(I2Cx) |= CR2_LAST_Set;
  }
  else
  {
    /* Next DMA transfer is not the last transfer */
    I2C_CR2(I2Cx) &= CR2_LAST_Reset;
  }
}
...
void I2C_GenerateSTART(uint32_t I2Cx, FunctionalState NewState)
{
  if (NewState != DISABLE)
  {
    ...
    I2C_CR1(I2Cx) |= CR1_START_Set;
  }
  else
  {
    /* Disable the START condition generation */
    I2C_CR1(I2Cx) &= CR1_START_Reset;
  }
}
...
void I2C_GenerateSTOP(uint32_t I2Cx, FunctionalState NewState)
{
  if (NewState != DISABLE)
  {
    ...
    I2C_CR1(I2Cx) |= CR1_STOP_Set;
  }
  else
  {
    /* Disable the STOP condition generation */
    I2C_CR1(I2Cx) &= CR1_STOP_Reset;
  }
}
...
void I2C_AcknowledgeConfig(uint32_t I2Cx, FunctionalState NewState)
{
  if (NewState != DISABLE)
  {
    ...
    I2C_CR1(I2Cx) |= CR1_ACK_Set;
  }
  else
  {
    /* Disable the acknowledgement */
    I2C_CR1(I2Cx) &= CR1_ACK_Reset;
  }
}
...
void I2C_DualAddressCmd(uint32_t I2Cx, FunctionalState NewState)
{
  if (NewState != DISABLE)
  {
    ...
    I2C_OAR2(I2Cx) |= OAR2_ENDUAL_Set;
  }
  else
  {
    /* Disable dual addressing mode */
    I2C_OAR2(I2Cx) &= OAR2_ENDUAL_Reset;
  }
}
...
void I2C_GeneralCallCmd(uint32_t I2Cx, FunctionalState NewState)
{
  if (NewState != DISABLE)
  {
    ...
    I2C_CR1(I2Cx) |= CR1_ENGC_Set;
  }
  else
  {
    /* Disable generall call */
    I2C_CR1(I2Cx) &= CR1_ENGC_Reset;
  }
}
...
void I2C_SoftwareResetCmd(uint32_t I2Cx, FunctionalState NewState)
{
  if (NewState != DISABLE)
  {
    ...
    I2C_CR1(I2Cx) |= CR1_SWRST_Set;
  }
  else
  {
    /* Peripheral not under reset */
    I2C_CR1(I2Cx) &= CR1_SWRST_Reset;
  }
}
...
{  
  ...
  if (I2C_NACKPosition == I2C_NACKPosition_Next)
  {
    ...
    I2C_CR1(I2Cx) |= I2C_NACKPosition_Next;
  }
  else
  {
    /* Current byte in shift register is the last received byte */
    I2C_CR1(I2Cx) &= I2C_NACKPosition_Current;
  }
}
...
void I2C_SMBusAlertConfig(uint32_t I2Cx, uint16_t I2C_SMBusAlert)
{
  if (I2C_SMBusAlert == I2C_SMBusAlert_Low)
  {
    ...
    I2C_CR1(I2Cx) |= I2C_SMBusAlert_Low;
  }
  else
  {
    /* Drive the SMBusAlert pin High  */
    I2C_CR1(I2Cx) &= I2C_SMBusAlert_High;
  }
}
...
void I2C_TransmitPEC(uint32_t I2Cx, FunctionalState NewState)
{
  if (NewState != DISABLE)
  {
    ...
    I2C_CR1(I2Cx) |= CR1_PEC_Set;
  }
  else
  {
    /* Disable the selected I2C PEC transmission */
    I2C_CR1(I2Cx) &= CR1_PEC_Reset;
  }
}
 ...
 if (I2C_PECPosition == I2C_PECPosition_Next)
  {
    ...
    I2C_CR1(I2Cx) |= I2C_PECPosition_Next;
  }
  else
  {
    /* Current byte in shift register is PEC */
    I2C_CR1(I2Cx) &= I2C_PECPosition_Current;
  }
}
 ...
 if (NewState != DISABLE)
  {
    ...
    I2C_CR1(I2Cx) |= CR1_ENPEC_Set;
  }
  else
  {
    /* Disable the selected I2C PEC calculation */
    I2C_CR1(I2Cx) &= CR1_ENPEC_Reset;
  }
}
 ...
 if (NewState != DISABLE)
  {
    ...
    I2C_CR1(I2Cx) |= CR1_ENARP_Set;
  }
  else
  {
    /* Disable the selected I2C ARP */
    I2C_CR1(I2Cx) &= CR1_ENARP_Reset;
  }
}
 ...
 if (NewState == DISABLE)
  {
    ...
    I2C_CR1(I2Cx) |= CR1_NOSTRETCH_Set;
  }
  else
  {
    /* Disable the selected I2C Clock stretching */
    I2C_CR1(I2Cx) &= CR1_NOSTRETCH_Reset;
  }
}
...
void I2C_FastModeDutyCycleConfig(uint32_t I2Cx, uint16_t I2C_DutyCycle)
{
  if (I2C_DutyCycle != I2C_DutyCycle_16_9)
  {
    ...
    I2C_CCR(I2Cx) &= I2C_DutyCycle_2;
  }
  else
  {
    /* I2C fast mode Tlow/Thigh=16/9 */
    I2C_CCR(I2Cx) |= I2C_DutyCycle_16_9;
  }
}
 ...
 *         library (hc32f10x_i2c.h) or to custom values defined by user.
...
/**
  ...
  *    I2C_Events in hc32f10x_i2c.h file.
  *    
...
/**
  ...
  *     I2C_SR2 register ((void)(I2C_SR2(I2Cx))).
...
ITStatus I2C_GetITStatus(uint32_t I2Cx, uint32_t I2C_IT)
{
  ...
  enablestatus = (uint32_t)(((I2C_IT & ITEN_Mask) >> 16) & (I2C_CR2(I2Cx))) ;
  
  /* Get bit[23:0] of the flag */
  I2C_IT &= FLAG_Mask;

  /* Check the status of the specified I2C flag */
  if (((I2C_SR1(I2Cx) & I2C_IT) != (uint32_t)RESET) && enablestatus)
  {
    /* I2C_IT is set */
    bitstatus = SET;
  }

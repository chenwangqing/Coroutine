...
/** @addtogroup _System_Private_FunctionPrototypes
  * @{
  */
...
/**
  ...
  *         
  *         (*) HSI_VALUE is a constant defined in hc32f1xx.h file (default value
  *             8 MHz) but the real value may vary depending on the variations
  *             in voltage and temperature.   
  *    
  *         (**) HSE_VALUE is a constant defined in hc32f1xx.h file (default value
...
void SystemCoreClockUpdate (void)
{
  ...
  switch (tmp)
  {
    ...
    case 0x08:  /* PLL used as system clock */
      ...
      pllmull = RCC_CFGR & RCC_CFGR_PLLMULL;
      ...
      else
      {
        ...
        if ((RCC_CFGR & RCC_CFGR_PLLXTPRE) != (uint32_t)RESET)
...
static void SetSysClockTo24(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    RCC_CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE | RCC_CFGR_PLLMULL));
    RCC_CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSE | RCC_CFGR_PLLXTPRE_HSE_Div2 | RCC_CFGR_PLLMULL6);
...
static void SetSysClockTo36(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    /* Flash 1 wait state */
    FLASH_ACR &= (uint32_t)((uint32_t)~FLASH_ACR_LATENCY);
    FLASH_ACR |= (uint32_t)FLASH_ACR_LATENCY_1;    
    ...
    RCC_CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE | RCC_CFGR_PLLMULL));
    RCC_CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSE | RCC_CFGR_PLLXTPRE_HSE_Div2 | RCC_CFGR_PLLMULL9);
...
static void SetSysClockTo48(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    /* PCLK1 = HCLK */
    RCC_CFGR |= (uint32_t)RCC_CFGR_PPRE1_DIV2;
   
    /*  PLL configuration: PLLCLK = HSE * 6 = 48 MHz */
    RCC_CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE | RCC_CFGR_PLLMULL));
    RCC_CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSE | RCC_CFGR_PLLMULL6);
...
static void SetSysClockTo56(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    RCC_CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE | RCC_CFGR_PLLMULL));
    RCC_CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSE | RCC_CFGR_PLLMULL7);

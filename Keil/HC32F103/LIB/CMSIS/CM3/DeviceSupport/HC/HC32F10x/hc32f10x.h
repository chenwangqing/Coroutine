 ...
 * @brief In the following line adjust the External High Speed oscillator (HSE) Startup 
   Timeout value 
   */
#define HSE_STARTUP_TIMEOUT   ((uint16_t)0x2500) /*!< Time out for HSE start up */

#define HSI_VALUE    ((uint32_t)8000000) /*!< Value of the Internal oscillator in Hz*/

/**
 * @brief hc32f10x Standard Peripheral Library version number
   */
#define __HC32F10X_STDPERIPH_VERSION_MAIN   (0x03) /*!< [31:24] main version */                                  
#define __HC32F10X_STDPERIPH_VERSION_SUB1   (0x05) /*!< [23:16] sub1 version */
#define __HC32F10X_STDPERIPH_VERSION_SUB2   (0x00) /*!< [15:8]  sub2 version */
#define __HC32F10X_STDPERIPH_VERSION_RC     (0x00) /*!< [7:0]  release candidate */ 
#define __HC32F10X_STDPERIPH_VERSION       ( (__HC32F10X_STDPERIPH_VERSION_MAIN << 24)\
                                             |(__HC32F10X_STDPERIPH_VERSION_SUB1 << 16)\
                                             |(__HC32F10X_STDPERIPH_VERSION_SUB2 << 8)\
                                             |(__HC32F10X_STDPERIPH_VERSION_RC))
 ...
 */
#define __MPU_PRESENT             0 /*!< devices does not provide an MPU */
...
/*!< HC32F10x Standard Peripheral Library old definitions (maintained for legacy purpose) */
...
#elif defined (hc32f10x_LD_VL) || defined (hc32f10x_MD_VL) || defined (hc32f10x_HD_VL)
 #define  RCC_CFGR_PLLSRC_HSI_Div2           ((uint32_t)0x00000000)        /*!< HSI clock divided by 2 selected as PLL entry clock source */
 #define  RCC_CFGR_PLLSRC_PREDIV1            ((uint32_t)0x00010000)        /*!< PREDIV1 clock selected as PLL entry clock source */
...
#if !defined (hc32f10x_LD_VL) && !defined (hc32f10x_MD_VL) && !defined (hc32f10x_HD_VL)
...
#if !defined (hc32f10x_LD) && !defined (hc32f10x_LD_VL)
 #define  RCC_APB2RSTR_IOPERST               ((uint32_t)0x00000040)        /*!< I/O port E reset */
#endif /* hc32f10x_LD && hc32f10x_LD_VL */

#if defined (hc32f10x_HD) || defined (hc32f10x_XL)
...
#if defined (hc32f10x_HD) || defined (hc32f10x_MD) || defined (hc32f10x_LD) || defined  (hc32f10x_XL)
 #define  RCC_APB1RSTR_USBRST                ((uint32_t)0x00800000)        /*!< USB Device reset */
#endif

#if defined (hc32f10x_HD) || defined  (hc32f10x_CL) || defined  (hc32f10x_XL)
...
#if defined (hc32f10x_HD) || defined  (hc32f10x_CL) || defined  (hc32f10x_HD_VL)
...
#if defined (hc32f10x_HD) || defined (hc32f10x_MD) || defined  (hc32f10x_LD)
 #define  RCC_APB1ENR_USBEN                  ((uint32_t)0x00800000)        /*!< USB Device clock enable */
#endif

#if defined (hc32f10x_HD) || defined  (hc32f10x_CL)

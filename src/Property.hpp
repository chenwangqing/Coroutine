...
public:
    ...
    * @param get    读取函数
    * @param set    写入函数
    * @note     Property<Node, int>::RW<&Node::_get, &Node::_set> rw;  Node() : rw(this)
    * @author   CXS (chenxiangshu@outlook.com)
    * @date     2024-07-24
    */
    ...
    * @brief    只读
    * @param get    读取函数
    * @note     Property<Node, int>::RO<&Node::_get>              r;  Node() : r(this)
    * @author   CXS (chenxiangshu@outlook.com)
    * @date     2024-07-24
    */
    ...
    * @brief    只写
    * @param set    写入函数
    * @note     Property<Node, int>::WO<&Node::_set>              w;  Node() : w(this)
    * @author   CXS (chenxiangshu@outlook.com)
    * @date     2024-07-24
    */
